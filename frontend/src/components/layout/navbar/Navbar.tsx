    ...
    >
      ...
      <div className="flex items-center gap-4">
        <ThemeToggle />
          ...
          <button
            onClick={() => setOpen((o) => !o)}
            className="relative w-9 h-9 flex items-center justify-center md:hidden text-text-secondary hover:text-text-primary hover:bg-surface-hover rounded-full transition-colors duration-150"
